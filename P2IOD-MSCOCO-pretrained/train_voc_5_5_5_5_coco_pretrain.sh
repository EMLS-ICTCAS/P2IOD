...
plen=10
mlp_hidden_dim=64
exp_name="results/ppiod_for_voc_5_5_5_5_coco_pretrained_detector_topk_0.1_0.5"
split_task="voc_5_5_5_5"
...
python train.py \
    ...
    --n_gpus 4 --batch_size 4 --epochs 100 --lr_drop 80 --lr 1e-4 --lr_old 1e-5 --n_classes=21 --num_workers=2 --split_task=${split_task}\
    --use_prompts $use_prompts --prompt_len=$plen --mlp_hidden_dim=$mlp_hidden_dim --freeze=${freeze} --viz --new_params=${new_params} \
    --start_task=1 --n_tasks=4 --save_epochs=25 --eval_epochs=25  --bg_thres=0.65 --bg_thres_topk=5\
    --checkpoint_dir ${EXP_DIR}'/Task_1' --checkpoint_task1_name 'checkpoint99.pth' --checkpoint_other_task_name 'fused_model.pth' --resume=0 --parameterized_prompt_fusion --topk_percent_ori=0.1 \
