...
plen=10
mlp_hidden_dim=64
exp_name="results/ppiod_for_voc_10_5_5_coco_pretrained_detector"
split_task="voc_10_5_5"
...
python train.py \
    ...
    --start_task=1 --n_tasks=3 --save_epochs=25 --eval_epochs=25  --bg_thres=0.65 --bg_thres_topk=5\
