...
resume_from = None
load_from = 'results/co_dino_vit_iod_coco_40_40_unfreeze_cls_branches_and_prompts_with_fusion_and_sparse_0.000003_and_pesudo_label_remove_current/co_dino_5scale_vit_large_coco_task1/epoch_1.pth'
pretrained = None
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/instances_train2017_sel_last_repeated_40_cats_true_order_of_class_with_order_of_classes.json',
