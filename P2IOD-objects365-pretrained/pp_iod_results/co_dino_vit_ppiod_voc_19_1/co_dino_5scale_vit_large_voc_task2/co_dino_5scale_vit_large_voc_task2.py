...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='split_dataset/voc_19_1/train_task_2.json',
        img_prefix='data/voc07/train/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='data/voc07/annotations/instances_val.json',
        img_prefix='data/voc07/val/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
log_level = 'INFO'
load_from = 'results/co_dino_vit_ppiod_voc_19_1/co_dino_5scale_vit_large_voc_task1/latest.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = 'results/co_dino_vit_ppiod_voc_19_1/co_dino_5scale_vit_large_voc_task2'
auto_resume = False
gpu_ids = range(0, 4)
