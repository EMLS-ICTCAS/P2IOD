...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='split_dataset/voc_19_1/train_task_1.json',
...
log_level = 'INFO'
load_from = 'Objects365_pretrained_codetr/pytorch_model.bin'
resume_from = None
workflow = [('train', 1)]
...
work_dir = 'results/co_dino_vit_ppiod_voc_19_1/co_dino_5scale_vit_large_voc_task1'
auto_resume = False
gpu_ids = range(0, 4)
