...
data_root = 'data/coco_for_VOC2007/'
img_norm_cfg = dict(
...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='split_dataset/voc_5_5_5_5/train_task_3.json',
        img_prefix='data/coco_for_VOC2007/train2017/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(type='LoadAnnotations', with_bbox=True),
            dict(type='RandomFlip', flip_ratio=0.5),
    ...
    val=dict(
        type='CocoDataset',
        ann_file='data/coco_for_VOC2007/annotations/instances_val2017.json',
        img_prefix='data/coco_for_VOC2007/val2017/',
        pipeline=[
            dict(type='LoadImageFromFile'),
            dict(
                type='MultiScaleFlipAug',
...
log_level = 'INFO'
load_from = 'results/co_dino_vit_iod_voc_5_5_5_5_unfreeze_cls_branches_and_prompts_with_fusion_and_sparse_0.000003_and_pesudo_label_remove_current/co_dino_5scale_vit_large_voc_task2/latest.pth'
resume_from = None
workflow = [('train', 1)]
        ...
        transformer=dict(
            ...
            decoder=dict(
                ...
                transformerlayers=dict(
                    ...
                    attn_cfgs=[
                        dict(
                            type='MultiheadAttentionWithPrompts',
                            embed_dims=256,
                            num_heads=8,
                            dropout=0.0),
                        dict(
...
work_dir = 'results/co_dino_vit_iod_voc_5_5_5_5_unfreeze_cls_branches_and_prompts_with_fusion_and_sparse_0.000003_and_pesudo_label_remove_current/co_dino_5scale_vit_large_voc_task3'
auto_resume = False
gpu_ids = range(0, 4)
