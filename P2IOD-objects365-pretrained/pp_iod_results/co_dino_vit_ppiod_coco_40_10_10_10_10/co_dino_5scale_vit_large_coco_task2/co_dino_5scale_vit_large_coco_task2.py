...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='split_dataset/coco_40_10_10_10_10/train_task_2.json',
...
log_level = 'INFO'
load_from = 'results/co_dino_vit_iod_coco_40_10_10_10_10_unfreeze_cls_branches_and_prompts_with_fusion_0.3_0.3_sparse_0.000003_pesudo_label/co_dino_5scale_vit_large_coco_task1/latest.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = 'results/co_dino_vit_iod_coco_40_10_10_10_10_unfreeze_cls_branches_and_prompts_with_fusion_0.3_0.3_sparse_0.000003_pesudo_label/co_dino_5scale_vit_large_coco_task2'
auto_resume = False
gpu_ids = range(0, 8)
