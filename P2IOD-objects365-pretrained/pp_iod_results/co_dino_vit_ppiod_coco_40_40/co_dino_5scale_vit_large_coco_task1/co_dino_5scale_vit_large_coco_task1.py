...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file=
        'data/coco/annotations/instances_train2017_sel_first_40_cats.json',
...
work_dir = 'results/co_dino_vit_iod_coco_40_40_unfreeze_cls_branches_and_prompts_with_fusion_and_sparse_0.000003/co_dino_5scale_vit_large_coco_task1'
auto_resume = False
gpu_ids = range(0, 8)
