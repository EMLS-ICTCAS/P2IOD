...
data = dict(
    ...
    train=dict(
        type='CocoDataset',
        ann_file='split_dataset/voc_10_5_5/train_task_2.json',
...
log_level = 'INFO'
load_from = 'results/co_dino_vit_iod_voc_10_5_5_unfreeze_cls_branches_and_prompts_with_fusion_and_sparse_0.000003_and_pesudo_label_remove_current/co_dino_5scale_vit_large_voc_task1/latest.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = 'results/co_dino_vit_iod_voc_10_5_5_unfreeze_cls_branches_and_prompts_with_fusion_and_sparse_0.000003_and_pesudo_label_remove_current/co_dino_5scale_vit_large_voc_task2'
auto_resume = False
gpu_ids = range(0, 2)
