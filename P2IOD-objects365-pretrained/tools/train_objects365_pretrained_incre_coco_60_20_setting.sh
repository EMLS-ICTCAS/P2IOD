...
work_dir='results/co_dino_vit_ppiod_coco_60_20'
config_dir='projects/configs/co_dino_vit_ppiod_coco_60_20'
...
# bash tools/dist_test.sh ${work_dir}'/co_dino_5scale_vit_large_coco_task2/co_dino_5scale_vit_large_coco_task2.py' ${work_dir}'/co_dino_5scale_vit_large_coco_task2/latest.pth' ${work_dir}'/co_dino_5scale_vit_large_coco_task2' $ngpu $portnum &> ${work_dir}/co_dino_5scale_vit_large_coco_task2/before_fusion.txt